...
export class CreateVideosTable1786620650706 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."videos_status_enum" AS ENUM('draft', 'uploaded', 'processing', 'ready', 'failed')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6d0ba63c0a50f6a0ebb9f810c8" ON "videos" ("channel_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6d0ba63c0a50f6a0ebb9f810c8"`);
